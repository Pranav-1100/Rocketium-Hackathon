...
async function fetchAds(searchTerms, audienceSizeMin, audienceSizeMax, region, adType, mediaType, platform, searchType) {
...
app.post('/fetch-ads', async (req, res) => {
    const { searchTerms, audienceSizeMin, audienceSizeMax, region, adType, mediaType, platform, searchType } = req.body;

    try {
        const adData = await fetchAds(searchTerms, audienceSizeMin, audienceSizeMax, region, adType, mediaType, platform, searchType);
